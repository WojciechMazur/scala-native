...
class InetAddress protected (ipAddress: Array[Byte], originalHost: String)
  ...
  def getCanonicalHostName(): String = {
    ...
    // def hostTimeoutExpired(timeNow: time_t): Boolean = { false
  ...
  def getHostAddress(): String = { "localhost"
  ...
  def getHostName(): String = { "localhost"
...
object InetAddress {
  ...
  def getByAddress(host: String, addr: Array[Byte]): InetAddress = new Inet4Address(addr.clone, host)
  //  {
