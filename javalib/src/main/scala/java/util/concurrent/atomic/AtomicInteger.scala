...
class AtomicInteger(private[this] var value: Int)
   ...
   * @since 9
   */
  final def weakCompareAndSetPlain(expectedValue: Int,
   ...
   * @since 9
   */
  final def compareAndExchangeAcquire(expectedValue: Int,
                                      newValue: Int): Int = {
    valueRef
   ...
   * @since 9
   */
  final def compareAndExchangeRelease(expectedValue: Int,
                                      newValue: Int): Int = {
    valueRef
   ...
   * @since 9
   */
  final def weakCompareAndSetVolatile(expectedValue: Int,
                                      newValue: Int): Boolean = {
    valueRef.compareExchangeWeak(expectedValue, newValue)._1
  }
   ...
   * @since 9
   */
  final def weakCompareAndSetAcquire(expectedValue: Int,
                                     newValue: Int): Boolean = {
    valueRef
   ...
   * @since 9
   */
  final def weakCompareAndSetRelease(expectedValue: Int,
                                     newValue: Int): Boolean = {
    valueRef
