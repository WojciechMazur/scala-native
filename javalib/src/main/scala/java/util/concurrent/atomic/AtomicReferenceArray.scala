...
class AtomicReferenceArray[E <: AnyRef](len: Int) extends Serializable {

  def this(array: Array[E]) = {
    this(array.size)
    System.arraycopy(array, 0, inner, 0, len)
  }

  private val inner: Array[AnyRef] = new Array[AnyRef](len)
