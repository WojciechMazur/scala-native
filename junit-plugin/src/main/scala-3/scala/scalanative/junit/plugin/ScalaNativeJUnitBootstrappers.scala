 ...
 *
 *  Scala Native similiary as Scala.js cannot use reflection to invoke JUnit
 ...
 *  Unfortunettly we cannot use sjs implementation directly, becouse
...
object ScalaNativeJUnitBootstrappers extends PluginPhase {
  def phaseName: String = "sn-junitBootstrappers"
