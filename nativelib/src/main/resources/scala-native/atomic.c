...
int8_t scalanative_atomic_load_explicit_byte(_Atomic(int8_t) * atm,
...
void scalanative_atomic_store_explicit_byte(_Atomic(int8_t) * atm, int8_t val,
                                            memory_order memoryOrder) {
...
int8_t scalanative_atomic_exchange_explicit_byte(_Atomic(int8_t) * atm,
                                                 int8_t val,
                                                 memory_order memoryOrder) {
...
bool scalanative_atomic_compare_exchange_strong_explicit_byte(
    _Atomic(int8_t) * atm, int8_t *expected, int8_t desired,
    memory_order onSucc, memory_order onFail) {
...
bool scalanative_atomic_compare_exchange_weak_explicit_byte(
    _Atomic(int8_t) * atm, int8_t *expected, int8_t desired,
    memory_order onSucc, memory_order onFail) {
...
int8_t scalanative_atomic_fetch_add_explicit_byte(_Atomic(int8_t) * atm,
                                                  int8_t val,
                                                  memory_order memoryOrder) {
...
int8_t scalanative_atomic_fetch_sub_explicit_byte(_Atomic(int8_t) * atm,
                                                  int8_t val,
                                                  memory_order memoryOrder) {
...
int8_t scalanative_atomic_fetch_and_explicit_byte(_Atomic(int8_t) * atm,
                                                  int8_t val,
                                                  memory_order memoryOrder) {
...
int8_t scalanative_atomic_fetch_or_explicit_byte(_Atomic(int8_t) * atm,
                                                 int8_t val,
                                                 memory_order memoryOrder) {
...
int8_t scalanative_atomic_fetch_xor_explicit_byte(_Atomic(int8_t) * atm,
                                                  int8_t val,
                                                  memory_order memoryOrder) {
...
int16_t scalanative_atomic_load_explicit_short(_Atomic(int16_t) * atm,
                                               memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_short(_Atomic(int16_t) * atm,
                                             int16_t val,
                                             memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
int16_t scalanative_atomic_exchange_explicit_short(_Atomic(int16_t) * atm,
                                                   int16_t val,
                                                   memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_short(
    _Atomic(int16_t) * atm, int16_t *expected, int16_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_short(
    _Atomic(int16_t) * atm, int16_t *expected, int16_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
int16_t scalanative_atomic_fetch_add_explicit_short(_Atomic(int16_t) * atm,
                                                    int16_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
int16_t scalanative_atomic_fetch_sub_explicit_short(_Atomic(int16_t) * atm,
                                                    int16_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
int16_t scalanative_atomic_fetch_and_explicit_short(_Atomic(int16_t) * atm,
                                                    int16_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
int16_t scalanative_atomic_fetch_or_explicit_short(_Atomic(int16_t) * atm,
                                                   int16_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
int16_t scalanative_atomic_fetch_xor_explicit_short(_Atomic(int16_t) * atm,
                                                    int16_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
int32_t scalanative_atomic_load_explicit_int(_Atomic(int32_t) * atm,
                                             memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_int(_Atomic(int32_t) * atm, int32_t val,
                                           memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
int32_t scalanative_atomic_exchange_explicit_int(_Atomic(int32_t) * atm,
                                                 int32_t val,
                                                 memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_int(
    _Atomic(int32_t) * atm, int32_t *expected, int32_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_int(
    _Atomic(int32_t) * atm, int32_t *expected, int32_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
int32_t scalanative_atomic_fetch_add_explicit_int(_Atomic(int32_t) * atm,
                                                  int32_t val,
                                                  memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
int32_t scalanative_atomic_fetch_sub_explicit_int(_Atomic(int32_t) * atm,
                                                  int32_t val,
                                                  memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
int32_t scalanative_atomic_fetch_and_explicit_int(_Atomic(int32_t) * atm,
                                                  int32_t val,
                                                  memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
int32_t scalanative_atomic_fetch_or_explicit_int(_Atomic(int32_t) * atm,
                                                 int32_t val,
                                                 memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
int32_t scalanative_atomic_fetch_xor_explicit_int(_Atomic(int32_t) * atm,
                                                  int32_t val,
                                                  memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
int64_t scalanative_atomic_load_explicit_long(_Atomic(int64_t) * atm,
                                              memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_long(_Atomic(int64_t) * atm, int64_t val,
                                            memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
int64_t scalanative_atomic_exchange_explicit_long(_Atomic(int64_t) * atm,
                                                  int64_t val,
                                                  memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_long(
    _Atomic(int64_t) * atm, int64_t *expected, int64_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_long(
    _Atomic(int64_t) * atm, int64_t *expected, int64_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
int64_t scalanative_atomic_fetch_add_explicit_long(_Atomic(int64_t) * atm,
                                                   int64_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
int64_t scalanative_atomic_fetch_sub_explicit_long(_Atomic(int64_t) * atm,
                                                   int64_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
int64_t scalanative_atomic_fetch_and_explicit_long(_Atomic(int64_t) * atm,
                                                   int64_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
int64_t scalanative_atomic_fetch_or_explicit_long(_Atomic(int64_t) * atm,
                                                  int64_t val,
                                                  memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
int64_t scalanative_atomic_fetch_xor_explicit_long(_Atomic(int64_t) * atm,
                                                   int64_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
uint8_t scalanative_atomic_load_explicit_ubyte(_Atomic(uint8_t) * atm,
                                               memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_ubyte(_Atomic(uint8_t) * atm,
                                             uint8_t val,
                                             memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
uint8_t scalanative_atomic_exchange_explicit_ubyte(_Atomic(uint8_t) * atm,
                                                   uint8_t val,
                                                   memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_ubyte(
    _Atomic(uint8_t) * atm, uint8_t *expected, uint8_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_ubyte(
    _Atomic(uint8_t) * atm, uint8_t *expected, uint8_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
uint8_t scalanative_atomic_fetch_add_explicit_ubyte(_Atomic(uint8_t) * atm,
                                                    uint8_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
uint8_t scalanative_atomic_fetch_sub_explicit_ubyte(_Atomic(uint8_t) * atm,
                                                    uint8_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
uint8_t scalanative_atomic_fetch_and_explicit_ubyte(_Atomic(uint8_t) * atm,
                                                    uint8_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
uint8_t scalanative_atomic_fetch_or_explicit_ubyte(_Atomic(uint8_t) * atm,
                                                   uint8_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
uint8_t scalanative_atomic_fetch_xor_explicit_ubyte(_Atomic(uint8_t) * atm,
                                                    uint8_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
uint16_t scalanative_atomic_load_explicit_ushort(_Atomic(uint16_t) * atm,
                                                 memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_ushort(_Atomic(uint16_t) * atm,
                                              uint16_t val,
                                              memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
uint16_t scalanative_atomic_exchange_explicit_ushort(_Atomic(uint16_t) * atm,
                                                     uint16_t val,
                                                     memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_ushort(
    _Atomic(uint16_t) * atm, uint16_t *expected, uint16_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_ushort(
    _Atomic(uint16_t) * atm, uint16_t *expected, uint16_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
uint16_t scalanative_atomic_fetch_add_explicit_ushort(
...
uint16_t scalanative_atomic_fetch_sub_explicit_ushort(
    _Atomic(uint16_t) * atm, uint16_t val, memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
uint16_t scalanative_atomic_fetch_and_explicit_ushort(
    _Atomic(uint16_t) * atm, uint16_t val, memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
uint16_t scalanative_atomic_fetch_or_explicit_ushort(_Atomic(uint16_t) * atm,
                                                     uint16_t val,
                                                     memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
uint16_t scalanative_atomic_fetch_xor_explicit_ushort(
    _Atomic(uint16_t) * atm, uint16_t val, memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
uint32_t scalanative_atomic_load_explicit_uint(_Atomic(uint32_t) * atm,
                                               memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_uint(_Atomic(uint32_t) * atm,
                                            uint32_t val,
                                            memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
uint32_t scalanative_atomic_exchange_explicit_uint(_Atomic(uint32_t) * atm,
                                                   uint32_t val,
                                                   memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_uint(
    _Atomic(uint32_t) * atm, uint32_t *expected, uint32_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_uint(
    _Atomic(uint32_t) * atm, uint32_t *expected, uint32_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
uint32_t scalanative_atomic_fetch_add_explicit_uint(_Atomic(uint32_t) * atm,
                                                    uint32_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
uint32_t scalanative_atomic_fetch_sub_explicit_uint(_Atomic(uint32_t) * atm,
                                                    uint32_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
uint32_t scalanative_atomic_fetch_and_explicit_uint(_Atomic(uint32_t) * atm,
                                                    uint32_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
uint32_t scalanative_atomic_fetch_or_explicit_uint(_Atomic(uint32_t) * atm,
                                                   uint32_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
uint32_t scalanative_atomic_fetch_xor_explicit_uint(_Atomic(uint32_t) * atm,
                                                    uint32_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
uint64_t scalanative_atomic_load_explicit_ulong(_Atomic(uint64_t) * atm,
                                                memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_ulong(_Atomic(uint64_t) * atm,
                                             uint64_t val,
                                             memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
uint64_t scalanative_atomic_exchange_explicit_ulong(_Atomic(uint64_t) * atm,
                                                    uint64_t val,
                                                    memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_ulong(
    _Atomic(uint64_t) * atm, uint64_t *expected, uint64_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_ulong(
    _Atomic(uint64_t) * atm, uint64_t *expected, uint64_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
uint64_t scalanative_atomic_fetch_add_explicit_ulong(_Atomic(uint64_t) * atm,
                                                     uint64_t val,
                                                     memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
uint64_t scalanative_atomic_fetch_sub_explicit_ulong(_Atomic(uint64_t) * atm,
                                                     uint64_t val,
                                                     memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
uint64_t scalanative_atomic_fetch_and_explicit_ulong(_Atomic(uint64_t) * atm,
                                                     uint64_t val,
                                                     memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
uint64_t scalanative_atomic_fetch_or_explicit_ulong(_Atomic(uint64_t) * atm,
                                                    uint64_t val,
                                                    memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
uint64_t scalanative_atomic_fetch_xor_explicit_ulong(_Atomic(uint64_t) * atm,
                                                     uint64_t val,
                                                     memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
char scalanative_atomic_load_explicit_char(_Atomic(char) * atm,
                                           memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_char(_Atomic(char) * atm, char val,
                                            memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
char scalanative_atomic_exchange_explicit_char(_Atomic(char) * atm, char val,
                                               memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_char(
...
bool scalanative_atomic_compare_exchange_weak_explicit_char(
    _Atomic(char) * atm, char *expected, char desired, memory_order onSucc,
    memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
char scalanative_atomic_fetch_add_explicit_char(_Atomic(char) * atm, char val,
                                                memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
char scalanative_atomic_fetch_sub_explicit_char(_Atomic(char) * atm, char val,
                                                memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
char scalanative_atomic_fetch_and_explicit_char(_Atomic(char) * atm, char val,
                                                memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
char scalanative_atomic_fetch_or_explicit_char(_Atomic(char) * atm, char val,
                                               memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
char scalanative_atomic_fetch_xor_explicit_char(_Atomic(char) * atm, char val,
                                                memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
unsigned char scalanative_atomic_load_explicit_uchar(_Atomic(unsigned char) *
                                                         atm,
                                                     memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_uchar(_Atomic(unsigned char) * atm,
                                             unsigned char val,
                                             memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
unsigned char scalanative_atomic_exchange_explicit_uchar(
...
bool scalanative_atomic_compare_exchange_strong_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char *expected,
    unsigned char desired, memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char *expected,
    unsigned char desired, memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
unsigned char scalanative_atomic_fetch_add_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char val, memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
unsigned char scalanative_atomic_fetch_sub_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char val, memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
unsigned char scalanative_atomic_fetch_and_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char val, memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
unsigned char scalanative_atomic_fetch_or_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char val, memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
unsigned char scalanative_atomic_fetch_xor_explicit_uchar(
    _Atomic(unsigned char) * atm, unsigned char val, memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
intptr_t scalanative_atomic_load_explicit_intptr(_Atomic(intptr_t) * atm,
                                                 memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_intptr(_Atomic(intptr_t) * atm,
                                              intptr_t val,
                                              memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}

intptr_t scalanative_atomic_exchange_intptr(_Atomic(intptr_t) * atm,
                                            intptr_t val) {
    return atomic_exchange(atm, val);
}

intptr_t scalanative_atomic_exchange_explicit_intptr(_Atomic(intptr_t) * atm,
                                                     intptr_t val,
                                                     memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_intptr(
    _Atomic(intptr_t) * atm, intptr_t *expected, intptr_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_intptr(
    _Atomic(intptr_t) * atm, intptr_t *expected, intptr_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
intptr_t scalanative_atomic_fetch_add_explicit_intptr(
...
intptr_t scalanative_atomic_fetch_sub_explicit_intptr(
    _Atomic(intptr_t) * atm, intptr_t val, memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
intptr_t scalanative_atomic_fetch_and_explicit_intptr(
    _Atomic(intptr_t) * atm, intptr_t val, memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
intptr_t scalanative_atomic_fetch_or_explicit_intptr(_Atomic(intptr_t) * atm,
                                                     intptr_t val,
                                                     memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
intptr_t scalanative_atomic_fetch_xor_explicit_intptr(
    _Atomic(intptr_t) * atm, intptr_t val, memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
size_t scalanative_atomic_load_explicit_csize(_Atomic(size_t) * atm,
                                              memory_order memoryOrder) {
    return atomic_load_explicit(atm, memoryOrder);
}
...
void scalanative_atomic_store_explicit_csize(_Atomic(size_t) * atm, size_t val,
                                             memory_order memoryOrder) {
    atomic_store_explicit(atm, val, memoryOrder);
}
...
size_t scalanative_atomic_exchange_explicit_csize(_Atomic(size_t) * atm,
                                                  size_t val,
                                                  memory_order memoryOrder) {
    return atomic_exchange_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_compare_exchange_strong_explicit_csize(
    _Atomic(size_t) * atm, size_t *expected, size_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_strong_explicit(atm, expected, desired,
                                                   onSucc, onFail);
}
...
bool scalanative_atomic_compare_exchange_weak_explicit_csize(
    _Atomic(size_t) * atm, size_t *expected, size_t desired,
    memory_order onSucc, memory_order onFail) {
    return atomic_compare_exchange_weak_explicit(atm, expected, desired, onSucc,
                                                 onFail);
...
size_t scalanative_atomic_fetch_add_explicit_csize(_Atomic(size_t) * atm,
                                                   size_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_add_explicit(atm, val, memoryOrder);
}
...
size_t scalanative_atomic_fetch_sub_explicit_csize(_Atomic(size_t) * atm,
                                                   size_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_sub_explicit(atm, val, memoryOrder);
}
...
size_t scalanative_atomic_fetch_and_explicit_csize(_Atomic(size_t) * atm,
                                                   size_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_and_explicit(atm, val, memoryOrder);
}
...
size_t scalanative_atomic_fetch_or_explicit_csize(_Atomic(size_t) * atm,
                                                  size_t val,
                                                  memory_order memoryOrder) {
    return atomic_fetch_or_explicit(atm, val, memoryOrder);
}
...
size_t scalanative_atomic_fetch_xor_explicit_csize(_Atomic(size_t) * atm,
                                                   size_t val,
                                                   memory_order memoryOrder) {
    return atomic_fetch_xor_explicit(atm, val, memoryOrder);
}
...
bool scalanative_atomic_flag_test_and_set_explicit(atomic_flag *obj,
                                                   memory_order order) {
...
void scalanative_atomic_flag_test_and_clear_explicit(atomic_flag *obj,
                                                     memory_order order) {
