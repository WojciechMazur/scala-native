...
#define MONITOR_OBJECT_BITS (__POINTER_WIDTH__ - 1)
#define MONITOR_INFLATION_MARK_MASK ((word_t)1 << MONITOR_OBJECT_BITS)
#define MONITOR_OBJECT_MASK (MONITOR_INFLATION_MARK_MASK - 1)
