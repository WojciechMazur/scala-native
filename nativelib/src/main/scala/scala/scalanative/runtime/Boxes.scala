...
// ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/runtime/Boxes.scala.gyb", line: 42)
...
// ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/runtime/Boxes.scala.gyb", line: 47)
  ...
  @inline def boxToCStruct(rawty: RawPtr, v: RawPtr): CStruct = {
    if (rawty == null) null
      ...
      val alloc = GC.alloc_atomic(rawty, sizeof[ObjectType])
      storeRawPtr(elemRawPtr(alloc, sizeof[Ptr[_]].toLong), v)
  ...
  @inline def unboxToCStruct(o: Object): RawPtr = {
    if (o == null) null
      ...
      val elemptr = elemRawPtr(rawptr, sizeof[Ptr[_]].toLong)
      loadRawPtr(elemptr)
    }
  }

// ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/runtime/Boxes.scala.gyb", line: 85)
...
// ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/runtime/Boxes.scala.gyb", line: 91)
}
