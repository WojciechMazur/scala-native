...
object Tag {
  ...
  case class CStruct[T <: unsafe.CStruct](of: java.lang.Class[T])
      extends Tag[T] {
    @alwaysinline private def meta: StructMetadataOps = {
      ClassTypeOps(Boxes.boxToPtr(toRawType(of))).structMetadata
    }

    @alwaysinline def size: CSize = meta.size.toUInt

    @alwaysinline def alignment: CSize = meta.alignment.toUInt

    @alwaysinline override def load(ptr: unsafe.Ptr[T]): T = {
      Boxes.boxToCStruct(toRawType(of), toRawPtr(ptr)).asInstanceOf[T]
    }

    @alwaysinline override def store(ptr: unsafe.Ptr[T], value: T): Unit = {
      libc.memcpy(toRawPtr(ptr), Boxes.unboxToCStruct(value), size)
    }
  }
  ...
  final case class CStruct0() extends Tag[unsafe.CStruct0] with StructTag {
    @alwaysinline def size: CSize = {
      var res = 0.toULong
      // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 184)
      align(res, alignment)
    }

    @alwaysinline def alignment: CSize = {
      var res = 1.toULong
      // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 191)
      res
    }

    @alwaysinline override def offset(idx: CSize): CSize = idx.toInt match {
      // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 202)
      case _ =>
        throwUndefined()
    }
  ...
  final case class CStruct1[T1](_1: Tag[T1])
    ...
    @alwaysinline def size: CSize = {
      var res = 0.toULong
      // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 182)
    ...
    @alwaysinline def alignment: CSize = {
      var res = 1.toULong
      // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 189)
    ...
    @alwaysinline override def offset(idx: CSize): CSize = idx.toInt match {
      // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 195)
      case 0 =>
        var res = 0.toULong
        // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 200)
  ...
  // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 257)
  ...
  @alwaysinline implicit def materializeCStructTag[
      T <: unsafe.CStruct: ClassTag]: Tag[T] =
    Tag.CStruct(
      implicitly[ClassTag[T]].runtimeClass.asInstanceOf[java.lang.Class[T]])
  ...
  // ###sourceLocation(file: "nativelib/src/main/scala/scala/scalanative/unsafe/Tag.scala.gyb", line: 290)
}
