...
object Op {
  ...
  final case class Load(ty: Type, ptr: Val, syncAttrs: Option[SyncAttrs]) extends Op
  final case class Store(ty: Type, ptr: Val, value: Val, syncAttrs: Option[SyncAttrs])
      extends Op
