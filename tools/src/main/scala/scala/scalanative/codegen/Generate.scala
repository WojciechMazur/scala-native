...
private[codegen] object Generate {
  ...
  private object Impl {
    ...
    val NativeExecutionContextLoopSig = nir.Type.Function(Seq(NativeExecutionContext), nir.Type.Int)
    val NativeExecutionContextLoopName = NativeExecutionContext.name
      .member(nir.Sig.Method("executeAvailableTasks", Seq(nir.Type.Int)))
